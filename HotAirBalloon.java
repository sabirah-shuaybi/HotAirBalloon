...
public class HotAirBalloon
{
    ...
    public boolean contains(Location mouseClick) {
        ...
        if (rightRope.contains(mouseClick))
            return true;
       //If none of the above conditions are met, return the boolean flag false (need to know this info for the onMouseDrag method in BalloonController Class)
        return false;
    ...
    public Color randomColor() {
      //Invoking the Random() method and assigning it to variable r of type Random
       Random r = new Random();
       int red = r.nextInt(255);
       int green = r.nextInt(255);
       int blue = r.nextInt(255);
       //Setting the balloon to a random color through invokation of Random() method and assigning the result of this method to three variables (red, green, blue)
